<?php
	...
	if(isset($_POST['firstname']) && isset($_POST['lastname']) && isset($_POST['cgpa']) && isset($_POST['sem']) && isset($_POST['dept']))
	{
		...
		if(!empty($cgpa))
		{
			$query="SELECT * FROM student WHERE firstname='$firstname' AND lastname='$lastname' AND cgpaper_grad>'$cgpa'";
		}
		if(!empty($sem))
		{
			$query="SELECT * FROM student WHERE firstname='$firstname' AND lastname='$lastname' AND cgpaper_grad>'$cgpa' AND sem='$sem'";
		}
		if(!empty($dept))
		{
			$query="SELECT * FROM student WHERE firstname='$firstname' AND lastname='$lastname' AND cgpaper_grad>'$cgpa' AND sem='$sem' AND department='$dept'";
		}
	}
?>
<!DOCTYPE html>
